...
SELECT rc.Dep_Airport_ID, r.Runway_ID, rc.Num_of_Runways, r.Length, r.Width, r.Surface_Type_Condition, Edge_Light_Intensity, WBC_Single, WBC_Dual, WBC_Two_Dual, WBC_Tandem_Two_Dual, Base_Marking_Condition, r.Edge_Light_Intensity, r.WBC_Single, r.WBC_Dual, r.WBC_Two_Dual, r.WBC_Tandem_Two_Dual, r.Base_Marking_Condition
...
SELECT airport_schedules.Dep_Airport_ID, airport_schedules.Schedules, airports.Facility_Type, airports.Wind_Indicator
...
SELECT sch.Dep_Airport_ID, sch.Schedules, sch.Facility_Type, sch.Wind_Indicator, run.Runway_ID, run.Length, run.Width, run.Surface_Type_Condition, run.Edge_Light_Intensity, run.WBC_Single, run.WBC_Dual, run.WBC_Two_Dual, run.WBC_Tandem_Two_Dual, run.Base_Marking_Condition
